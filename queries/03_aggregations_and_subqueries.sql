...
------------------------------------------------------------------------------------------------------------------------
-- 17. Listar el nombre, precio de lista, precio promedio y diferencia de precios entre cada producto y el valor 
--     promedio general.
-- Tablas: Production.Product
-- Campos: Name, ListPrice
------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------
-- 19. Mostrar el producto más barato de cada subcategoría. Mostrar subcategoría, código de producto y el precio de lista 
--     más barato ordenado por subcategoría.
-- Tablas: Production.Product
...
------------------------------------------------------------------------------------------------------------------------
-- 29. Listar los productos cuyos precios de venta sean mayores o iguales que el precio de venta máximo de cualquier 
--     subcategoría.
-- Tablas: Production.Product
